...
class IllustratorApplication(QtWidgets.QMainWindow):
    ...
    def Renew_Intr(self, Freq):
        ...
        self.Dotted_plot = self.gui.composed(self.Signal_test.Time_Intrv, self.Signal_test.Samples, pen="k", symbol='+')
        ...
        # difference = self.gui.plot_widget_main_signal. - IllustratorApplication.interpolate_f
    ...
    def plotOnMain(self, Time, Amplitude, Name):
        ...
        self.gui.composed(Time, Amplitude, pen="r")
        ...
        print (self.Signal_test.amplitude.count())

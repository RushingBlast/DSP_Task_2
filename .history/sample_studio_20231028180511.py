...
class IllustratorApplication(QtWidgets.QMainWindow):
    ...
    def Connect_Buttons(self):
        # Buttons
        self.gui.actionAdd_Signal.triggered.connect(self.open_sig_file)
        # self.gui.show_sin_Button.clicked.connect(self.plot_sig_on_plot_widget_component)
        ...
        self.gui.pushButton.clicked.connect(self.plot_resultant_sig_on_mainGraph)
        # slider:
    ...
    def delete_sigComponent_from_resultantGraph(self):
        signal_name = self.gui.listWidget.currentText()
        if signal_name != "":
